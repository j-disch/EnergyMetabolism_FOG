% function [f,J,Kapp,] = dXdTMuscleMetabolism_OxPhos_FT_MPSA(t,x,BX,K_BX,Xcp0_NADH,Kn_NADH,par,clamp_idx,sppar)
%
%
%
% Output parameters:
...
%   sppar   parameter vector for the specified parameters
...
Kg3pdh_g3p=sppar(28);
Kg3pdh_nad=sppar(29);
Kg3pdh_dhap=sppar(30);
Kg3pdh_nadh=sppar(31);
Vbbg3pdh=x_G3PDH;
